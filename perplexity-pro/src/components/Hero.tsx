        ...
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <p className="mt-8 max-w-2xl mx-auto text-xl text-gray-400 mb-12 leading-relaxed font-light">
                    تجربه‌ای فراتر از جستجوی معمولی. با دسترسی همزمان به <span className="text-white font-medium">GPT-5.1</span>، <span className="text-white font-medium">Claude Sonnet 4.5</span> و <span className="text-white font-medium">Gemini 3 Pro</span>، پاسخ‌های دقیق‌تر دریافت کنید.
                </p>
