...
import { Check, X, Zap, Brain, FileText, Image as ImageIcon, Shield, Lock, Link2 } from "lucide-react";

const comparisonData = [
    {
        feature: "مدل‌های هوش مصنوعی",
        free: "مدل استاندارد (سریع)",
        pro: "GPT-4o, Claude 3.5, Sonar Huge",
        icon: Brain,
        highlight: true
    },
    {
        feature: "جستجوی حرفه‌ای (Pro Search)",
    ...
    {
        feature: "مدل‌های تصویرساز",
        free: "غیرفعال ❌",
        pro: "Playground v3, DALL-E 3, FLUX.1",
        icon: ImageIcon,
        highlight: false
    },
    {
        ...
        free: "۳ فایل در روز",
        pro: "نامحدود (PDF, CSV, Code)",
        icon: FileText,
        highlight: false
    },
    {
        feature: "کانکتورهای داده (Yelp, Maps...)",
        free: "محدود",
        pro: "دسترسی کامل و نامحدود",
        icon: Link2,
        highlight: false
    },
    {
